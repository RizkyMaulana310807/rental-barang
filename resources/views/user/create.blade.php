<x-layout>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            <h2 class="text-2xl font-bold text-indigo-800">Tambah Data Pengguna</h2>
            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="w-full md:w-1/2 bg-indigo-50 rounded-xl p-6 flex flex-col items-center justify-center">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-medium text-indigo-800 mt-4">Tambah Pengguna Baru</h3>
                        <p class="text-gray-600 mt-2">Isi formulir dengan detail pengguna yang ingin ditambahkan.</p>
                    </div>
                </div>
            </div>
        </div>
